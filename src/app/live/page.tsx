 ...
 * Live Timing (PRD 7.3).
 *
 * Every number on this page arrives through LiveTimingSource, so the page is
 * identical whether it is drawing post-session classifications from Jolpica or
 * second-by-second timing from OpenF1. What changes is the fidelity banner and
 * which panels render data instead of an explanation.
 */
